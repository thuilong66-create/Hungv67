"""
🏆 SERVER AI - VIP THEO CẦU 60 v15.0
═══════════════════════════════════════════════
...
app = FastAPI(title="🏆 VIP THEO CẦU 60 v15.0", version="15.0")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
async def home():
    ...
    return {"status": "ok", "msg": "🏆 VIP THEO CẦU 60 v15.0 đang chạy"}
...
if __name__ == "__main__":
    ...
    logger.info(f"🏆 VIP THEO CẦU 60 v15.0 | Bỏ phiếu đa số | Cổng {port}")
