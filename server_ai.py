"""
🏆 SERVER AI - VIP 3-IN-1 v15.5 (Auto+Random+ML)
═══════════════════════════════════════════════
...
app = FastAPI(title="🏆 VIP 3-IN-1 v15.5 (Auto+Random+ML)", version="15.0")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
async def home():
    ...
    return {"status": "ok", "msg": "🏆 VIP 3-IN-1 v15.5 (Auto+Random+ML) đang chạy"}
    ...
    try:
        ...
        if mode == 'random':
            ...
            if ket_qua_ml:
                ...
                # Chưa đủ dữ liệu ML → fallback về auto
...
if __name__ == "__main__":
    ...
    logger.info(f"🏆 VIP 3-IN-1 v15.5 (Auto+Random+ML) | Bỏ phiếu đa số | Cổng {port}")
